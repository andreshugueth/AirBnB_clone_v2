#!/usr/bin/python3
""" Module for testing file models.storage"""
import unittest
...
class test_fileStorage(unittest.TestCase):
    """ Class to test the file models.storage method """
    ...
    def test_base_model_save(self):
        """ BaseModel save method calls models.storage save """
        new = BaseModel()
        new.save()
        self.assertTrue(os.path.exists('file.json'))
    ...
    def test_storage_var_created(self):
        """ FileStorage object models.storage created """
